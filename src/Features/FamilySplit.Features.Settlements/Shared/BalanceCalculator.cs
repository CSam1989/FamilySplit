namespace FamilySplit.Features.Settlements.Shared;
...
/// Pure — takes plain data, no EF. Lives in the slice's <c>Shared/</c> so the Generate command
/// (business logic) can call it directly and it is unit-tested without a database (ADR-001).
/// </summary>
