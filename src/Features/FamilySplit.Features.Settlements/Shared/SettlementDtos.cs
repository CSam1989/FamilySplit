...
// ── Response DTOs ─────────────────────────────────────────────────────────────
// Shared across the slice's query handlers (the read-side wire-format lock). Kept here
// rather than in a single query folder because several queries project to them.
