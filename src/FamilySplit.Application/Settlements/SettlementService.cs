...
public class SettlementService
{
    ...
    public async Task<List<FamilyBalanceDto>> GetBalancesAsync(Guid activityId, Guid callerId, CancellationToken ct = default)
    {
    ...
    public async Task<List<SettlementSummaryDto>> GenerateAsync(Guid activityId, Guid callerId, CancellationToken ct = default)
    {
        ...
        if (transfers.Count == 0)
        {
            ...
            var activityEntity = await _db.Activities.FindAsync([activityId], ct);
    ...
    public async Task<List<GroupSettlementSummaryDto>> ListForGroupAsync(Guid groupId, Guid callerId, CancellationToken ct = default)
    {
    ...
    public async Task<List<GroupSettlementSummaryDto>> ListMyPendingAsync(Guid callerId, CancellationToken ct = default)
    {
    ...
    public async Task<List<SettlementSummaryDto>> ListAsync(Guid activityId, Guid callerId, CancellationToken ct = default)
    {
    ...
    public async Task<SettlementDetailDto> GetDetailAsync(Guid settlementId, Guid callerId, CancellationToken ct = default)
    {
    ...
    public async Task<SettlementDetailDto> ConfirmSentAsync(Guid settlementId, Guid callerId, CancellationToken ct = default)
    {
    ...
    public async Task<SettlementDetailDto> ConfirmReceivedAsync(Guid settlementId, Guid callerId, CancellationToken ct = default)
    {
    ...
    private async Task<(List<BalanceCalculator.ExpenseData>, List<BalanceCalculator.ParticipantData>)>
        LoadExpenseDataAsync(Guid activityId, CancellationToken ct)
    {
        var allIds = await GetActivityAndSubIdsAsync(activityId, ct);
    ...
    private async Task<List<SettlementSummaryDto>> BuildSummaryListAsync(Guid activityId, CancellationToken ct)
    {
        var rows = await (
            from s in _db.Settlements
            join pf in _db.Families on s.PayerFamilyId equals pf.Id
    ...
    private async Task<SettlementDetailDto> BuildDetailDtoAsync(Guid settlementId, CancellationToken ct)
    {
        var s = await (
