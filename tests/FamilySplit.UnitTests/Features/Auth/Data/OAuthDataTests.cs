...
public class OAuthDataTests : IDisposable
{
    ...
    private OAuthData CreateSut(HttpMessageHandler handler)
    {
        ...
        return new OAuthData(_db, _configMock.Object, factoryMock.Object, NullLogger<OAuthData>.Instance);
    }

    private OAuthData CreateSut() => new(_db, _configMock.Object, Mock.Of<IHttpClientFactory>(), NullLogger<OAuthData>.Instance);
