...
> migrated: **Expenses**, **Dashboard**, **Users**, **Groups**, **Activities**, **Settlements**, **Admin**, **Families**, **Auth**.
> Sections below that describe `FamilySplit.Application`
> services still document live code for the **un-migrated** slice (Push), but **new feature work must
